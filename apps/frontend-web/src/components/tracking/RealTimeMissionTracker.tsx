...
export default function RealTimeMissionTracker({ className = '' }: RealTimeMissionTrackerProps) {
  ...
  const stats = {
    ...
    highPriority: missions.filter((m) => m.budgetMin! > 200000).length,
  };
      ...
      <div className={`flex items-center justify-center bg-gray-100 rounded-lg ${className}`}>
        <div className="text-center p-4 sm:p-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            {tTracking('realTime.loadingMissions')}
          </p>
        </div>
      </div>
    );
    ...
    <div className={`space-y-4 sm:space-y-6 ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 justify-between items-start sm:items-center">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs sm:text-sm text-gray-600">
                {isConnected ? tTracking('realTime.connected') : tTracking('realTime.disconnected')}
              </span>
            </div>
            <span className="text-xs sm:text-sm text-gray-500">
              {tTracking('realTime.lastUpdate', { time: lastUpdate.toLocaleTimeString() })}
            </span>
          </div>
        </div>
        <Button
        ...
        >
          ...
          <span className="hidden sm:inline">{tTracking('realTime.refresh')}</span>
        </Button>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-gray-600">
                  {tTracking('realTime.totalMissions')}
                </p>
        ...
        <Card className="col-span-2 sm:col-span-1">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-gray-600">
                  {tTracking('realTime.highPriority')}
                </p>
          ...
          <Card>
            <CardHeader className="pb-3 sm:pb-6">
              <CardTitle className="flex items-center gap-2 text-base sm:text-lg">
                ...
                <span className="hidden sm:inline">{tTracking('realTime.realTimeMap')}</span>
                <span className="sm:hidden">{tTracking('realTime.realTimeMapShort')}</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <MissionTrackingMap
            ...
            <Card>
              <CardHeader className="pb-3 sm:pb-6">
                <CardTitle className="flex items-center justify-between text-sm sm:text-base">
                  <span className="truncate">{tTracking('realTime.selectedMission')}</span>
                  <Badge
                    className={`
              ...
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-2 text-xs sm:text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">{tTracking('realTime.type')}:</span>
                    <span className="font-medium truncate ml-2">
                      {selectedMission.typeMarchandise}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">{tTracking('realTime.weight')}:</span>
                    <span className="font-medium">{selectedMission.poids} kg</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">{tTracking('realTime.volume')}:</span>
                    <span className="font-medium">{selectedMission.volume} m³</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">{tTracking('realTime.budget')}:</span>
                    <span className="font-medium text-green-600">
                      {selectedMission.budgetMin?.toLocaleString()} FCFA
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">{tTracking('realTime.delivery')}:</span>
                  ...
                  <div className="p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-red-800">
                        {tTracking('realTime.priorityMission')}
                      </span>
                    </div>
                    <p className="text-xs text-red-600 mt-1">
                      {tTracking('realTime.highBudgetTracking')}
                    </p>
                  </div>
                )}
              </CardContent>
            ...
            <Card>
              <CardContent className="p-4 sm:p-8 text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">
                  {tTracking('realTime.noMissionSelected')}
                </h3>
                <p className="text-xs sm:text-sm text-gray-600">
                  {tTracking('realTime.clickMarkerForDetails')}
                </p>
              </CardContent>
            </Card>
          )}
          ...
          <Card>
            <CardHeader className="pb-3 sm:pb-6">
              <CardTitle className="text-sm sm:text-base">
                {tTracking('realTime.recentActivity')}
              </CardTitle>
            </CardHeader>
            <CardContent>
