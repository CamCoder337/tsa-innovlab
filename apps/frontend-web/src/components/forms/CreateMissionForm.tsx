...
export default function CreateMissionForm({ onSubmit, isSubmitting = false }: CreateMissionFormProps) {
    return (
                        ...
                        <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className={cn("pl-10", touched.destination && errors.destination && "border-red-500")}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        <SelectTrigger className={cn(touched.cargoType && errors.cargoType && "border-red-500")}>
                                ...
                                <div>
                                    ...
                                    >
                                        <SelectTrigger className={cn(touched.urgency && errors.urgency && "border-red-500")}>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            name="proposedPrice"
                                            placeholder="0"
                                            className={cn("pl-10", touched.proposedPrice && errors.proposedPrice && "border-red-500")}
