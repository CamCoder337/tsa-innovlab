                    ...
                    {category.subcategories.map((sub) => (
                      <div key={sub} className="flex items-center gap-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleCategoryChange(sub, checked as boolean)
                          }
                        />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                value={priceRange[0]}
                onChange={(e) =>
                  handlePriceRangeChange([Number.parseInt(e.target.value) || 0, priceRange[1]])
                }
                className="w-20"
                min={0}
              />
              ...
              <Input
                ...
                value={priceRange[1]}
                onChange={(e) =>
                  handlePriceRangeChange([priceRange[0], Number.parseInt(e.target.value) || 5000])
                }
                className="w-20"
                min={0}
              />
