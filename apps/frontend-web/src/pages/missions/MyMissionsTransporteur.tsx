...
import { MapPin, Package, Star, MessageSquare, Eye, CheckCircle, Search, Filter, Truck, DollarSign } from "lucide-react"
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{missions.filter((m) => m.status === "assignee").length}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{missions.filter((m) => m.status === "en_transit").length}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                            ...
                            <TabsContent value={activeTab} className="mt-6">
                                                ...
                                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                                    <div className="flex-1">
                                                        <div className="flex items-start justify-between mb-3">
                                                            ...
                                                            {mission?.urgency && <div className="flex gap-2">
                                                        ...
                                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <span className="ml-1 font-medium">
                                                                    {Math.round((mission.finalPrice || mission.proposedPrice) / (mission.distance || 1))} FCFA
                                                                </span>
                                                            </div>
                                                        </div>

                                                        {mission?.shipper && <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg">
                                                            ...
                                                            <div>
                                                                <p className="text-sm font-medium text-blue-800">{mission.shipper.company}</p>
                                ...
                                {filteredMissions.length === 0 && (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-600">Aucune mission ne correspond aux critères de recherche actuels</p>
                                    </div>
                                )}
                            </TabsContent>
                        </Tabs>
