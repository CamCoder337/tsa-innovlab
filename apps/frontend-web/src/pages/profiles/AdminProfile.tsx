...
import { Users, Settings, Shield, Mail, Phone, Building, MapPin, Save, Edit, X, BarChart3, ServerCog } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Gérez vos informations et surveillez la plateforme</p>
                </div>
                {!isEditing ? (
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center gap-4 mb-6">
                            <Avatar className="h-20 w-20">
                                ...
                                <AvatarFallback className="text-lg" style={{ backgroundColor: 'var(--tsa-blue)', color: 'white' }}>
                                    {user.nom
                                        .split(' ')
                                        .map((n) => n[0])
                                        .join('')}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="phone" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} disabled={!isEditing} className="pl-10" placeholder="+237 677 123 456" />
                                </div>
                            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="address" value={formData.address} onChange={(e) => setFormData({ ...formData, address: e.target.value })} disabled={!isEditing} className="pl-10" placeholder="Votre adresse complète" />
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            <p className="text-sm text-muted-foreground">L'administration peut gérer les rôles des utilisateurs et les autorisations.</p>
                            <Separator />
                            <div className="flex gap-2">
                                <Button variant="outline" size="sm">Gérer les utilisateurs</Button>
                                <Button variant="outline" size="sm">Politiques d'accès</Button>
                            </div>
                        </CardContent>
                    </Card>
                </div>
