...
import { mockUsers, useAuthStore } from '@/stores/user'
                            ...
                            <CardContent className="px-8">
                                <Formik<LoginFormData>
                                    ...
                                    onSubmit={async (data: LoginFormData) => {
                                        // Simple mock: pick role based on email prefix, else default Affréteur
                                        const email = data.email.trim().toLowerCase()
                                        let role: UserRole = 'Admin'
                                        if (email.startsWith('affreteur')) role = 'Affreteur'
                                        else if (email.startsWith('transporteur')) role = 'Transporteur'
