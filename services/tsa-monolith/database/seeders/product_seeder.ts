  ...
  async run() {
    ...
    const products = [
      // Électronique (6 produits)
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=400']),
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1565849904461-04a58ad377e0?w=400']),
        specifications: JSON.stringify({
          storage: '256GB',
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=400']),
        specifications: JSON.stringify({
          size: '27 inches',
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1612198188060-c7c2a3b66eae?w=400']),
        specifications: JSON.stringify({
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=400']),
        specifications: JSON.stringify({
          type: 'Mechanical',
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=400']),
        specifications: JSON.stringify({
          dpi: '30000 DPI',
      ...
      },
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1581539250439-c96689b516dd?w=400']),
        specifications: JSON.stringify({
      ...
      // Équipements Industriels (6 produits)
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400']),
        specifications: JSON.stringify({
      ...
      // Véhicules et Transport (6 produits)
      {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400']),
        specifications: JSON.stringify({
          capacity: '3.5 tons',
          volume: '12.8 m³',
          engine: '2.3L Diesel',
